// ═══════════════════════════════════════════════════════════
// Mock & Initial Data for J뉴스보드
// ═══════════════════════════════════════════════════════════

export const DEFAULT_POSTS = [
  { id:1, category:'notice', categoryName:'공지', title:'📢 J뉴스보드 시스템 정기 점검 안내 (09/25)', author:'시스템 관리자', authorAvatar:'https://api.dicebear.com/7.x/bottts/svg?seed=Admin', content:'안정적인 서비스 운영을 위해 데이터베이스 정기 점검 및 서버 패치 작업이 진행될 예정입니다.\n점검 시간 동안에는 서비스 접속이 일시적으로 제한될 수 있습니다.', views:1240, likes:42, comments:[{author:'김개발',date:'2026-09-22 09:15',content:'공지 확인했습니다!'}], createdAt:'2026-09-22 09:00', isNotice:true },
  ...
  { id:4, category:'free', categoryName:'자유', title:'새로운 J뉴스보드 프로젝트를 시작했습니다!', author:'최신입', authorAvatar:'https://api.dicebear.com/7.x/avataaars/svg?seed=Choi', content:'사내 게시판 및 관리자 툴 통합 프로젝트를 준비하고 있습니다.\n다양한 기능 제안 환영합니다.', views:512, likes:29, comments:[], createdAt:'2026-09-20 18:05', isNotice:false },
